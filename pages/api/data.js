export const data = [
  ...
  "url": "/midsommartacos",
  "sponsored": null,
  "description": "Sommarens tacos är fylld med gubbröra, hummerröra eller kall potatis och sill!",
    "image": {
    "name": "Midsommartacos",
    "photographer": "Tv4",
  ...
  "url": "/vit-kimchi",
  "sponsored": null,
  "description": "Sommarkimchi är en mildare variant av klassisk kimchi, den får en härlig fräsch smak från äpple och ingefära. \n\nReceptet kommer ur boken _Kimchi och kombuca_ av Soki Choi",
    "image": {
    "name": "Vit kimchi",
  ...
  {
  "id": 30353,
  "name": "Sommarcheesecake",
  "type": "recipe",
  "url": "/sommarcheesecake",
  "sponsored": true,
  "description": "En klassisk och frisk cheesecake toppad med sommarens bär!",
  "image": {
    "name": "Sommarcheesecake",
    "photographer": "Philadelphia",
    "url": "https://img.koket.se/standard-large/sommarcheesecake.jpg"
    }
  },
  {
  "id": 980,
  "name": "Potatissallad är sommarens favorit",
  "type": "article",
  "url": "/potatissallad-ar-sommarens-favorit",
  "sponsored": null,
  "description": "Recept på potatissallad är det våra besökare söker efter mest i matväg under sommaren! Här hittar du våra bästa recept på potatissallad.",
  "image": {
    "name": "kalasgott till grillfesten",
    "photographer": "Jennie Benjaminsson",
    "url": "https://img.koket.se/standard-large/kalasgott-tillgrillfesten.jpg"
    }
  },
  {
  "id": 38715,
  "name": "Klassisk jordgubbstårta",
  "type": "recipe",
  "url": "/klassisk-jordgubbstarta",
  "sponsored": true,
  "image": {
    "name": "Klassisk jordgubbstårta",
    "photographer": "Köket.se",
    "url": "https://img.koket.se/standard-large/klassiskjordgubbstarta-2.png"
    }
  },
  {
  "id": 30822,
  ...
  "url": "/tomatpaj-2",
  "sponsored": true,
  "description": "En alldeles ljuvlig paj fylld med ugnsrostade tomater, vitlök, timjan och ost. Den tar lite tid att göra, men är så värd det!*Klicka här för att få fler smarta recept eller bli medlem i WW ViktVäktarna.",
  "image": {
    "name": "Tomatpaj",
    "photographer": "WW ViktVäktarna",
    "url": "https://img.koket.se/standard-large/tomatpaj-3.jpg"
    }
  }
]